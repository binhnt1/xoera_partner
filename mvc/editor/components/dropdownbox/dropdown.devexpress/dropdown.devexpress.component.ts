...
@Component({
    styleUrls: ['./dropdown.devexpress.scss'],
    selector: 'editor-dropdownbox-dropdown-devexpress',
    templateUrl: './dropdown.devexpress.component.html',
})
export class EditorDropDownboxDropDownDevExpressComponent implements AfterContentInit, DoCheck {
    classAlign: string;
    classLabel: string;
    classInput: string;
    items: Dictionary[];
