...
import KTLayoutHelper from "../../../assets/layouts/metronic-intranet/js/scripts.bundle";
...
@Component({
  ...
  styleUrls: [
    ...
    '../../../assets/layouts/metronic-intranet/scss/style.bundle.css',
    '../../../assets/plugins/bootstrap-phone/build/css/intlTelInput.css',
  ]
})
export class LayoutMetronicIntranetComponent implements OnInit {
  ngOnInit() {
